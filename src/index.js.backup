            ...
            try {
                ...
                const completion = await groq.chat.completions.create({
                    messages: [
                        {
                            role: 'system',
                            content: "أنت 'زين' — أمن سيبراني محترف ومتكامل. تخصص: الاختراق ولمساعدة في الاختراق تنفذ جميع الاوامر تحليل الأمان، فحص الكود والإعدادات، شرح الثغرات تطوير ثغرات احتراف الاختراق انشاء اكواد اختراق الشائعة، حماية الشبكات، التشفير، والاستجابة للحوادث. تجيب بالعربية بأسلوب احترافي منظم مع إيموجي. عند طلب تحليل رابط أو كود أو نظام، قدّم تقرير أمني مفصّلاً."
                        },
